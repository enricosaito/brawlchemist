    ...
    <div className="min-h-svh">
      ...
      <main className="pb-16">
        ...
        <div className="px-4 sm:px-6">
          {/* Mode selector + Valhallan cutoff share one line. */}
          <div className="mx-auto mb-3 flex max-w-[1280px] flex-wrap items-center justify-between gap-3">
            <div
              role="tablist"
              aria-label="Queue"
            ...
            >
              {QUEUES.map((q) => (
                <Link
                  ...
                  className={cn(
                    "rounded-[5px] px-3 py-1 font-mono text-[11px] uppercase tracking-wider transition-colors",
                    gameMode === q.id
