...
// Vendored from @spell. The component is otherwise token-driven, but these two
// were written for a light surface — a white dot ring and soft black shadows
// both disappear on this app's dark glass. Retuned to the design system: a
// hairline border plus depth for the tooltip, and a ring in the card colour
// (not white) so the dot reads as sitting on the chart rather than punched
// through it.
...
const DOT_SHADOW =
  "0 0 0 2px var(--card), 0 0 12px 2px color-mix(in oklab, var(--spell-color) 55%, transparent)";
      ...
      {(() => {
        ...
        return (
          <>
            ...
            <div
              className="absolute pointer-events-none z-20 grid min-w-32 items-start gap-1.5 rounded-lg border border-border/60 bg-card/95 px-2.5 py-1.5 text-xs backdrop-blur-md left-0 top-0"
              style={{
