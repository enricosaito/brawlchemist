...
export const LEGENDS: Legend[] = [
  { id: "caspian", name: "Caspian", weapons: ["katar", "gauntlets"], tier: "S", pickRate: 9.4, winRate: 53.8, deltaWR: 1.2 },
  { id: "bodvar", name: "Bödvar", weapons: ["sword", "hammer"], tier: "S", pickRate: 6.1, winRate: 52.1, deltaWR: 0.4 },
  { id: "orion", name: "Orion", weapons: ["spear", "rocket-lance"], tier: "S", pickRate: 5.7, winRate: 51.6, deltaWR: 0.9 },
  { id: "mirage", name: "Mirage", weapons: ["spear", "scythe"], tier: "S", pickRate: 4.9, winRate: 51.4, deltaWR: -0.2 },
  { id: "val", name: "Val", weapons: ["sword", "gauntlets"], tier: "A", pickRate: 4.2, winRate: 50.9, deltaWR: 0.3 },
  { id: "ada", name: "Ada", weapons: ["spear", "blasters"], tier: "A", pickRate: 3.8, winRate: 50.4, deltaWR: 0.7 },
  { id: "petra", name: "Petra", weapons: ["gauntlets", "orb"], tier: "A", pickRate: 3.5, winRate: 50.2, deltaWR: -0.1 },
  { id: "mordex", name: "Mordex", weapons: ["scythe", "gauntlets"], tier: "A", pickRate: 3.3, winRate: 50.0, deltaWR: 0.2 },
  { id: "lucien", name: "Lucien", weapons: ["katar", "blasters"], tier: "A", pickRate: 3.1, winRate: 49.8, deltaWR: -0.3 },
  { id: "diana", name: "Diana", weapons: ["bow", "blasters"], tier: "A", pickRate: 2.9, winRate: 49.7, deltaWR: 0.1 },
  { id: "hattori", name: "Hattori", weapons: ["sword", "spear"], tier: "B", pickRate: 2.7, winRate: 49.2, deltaWR: 0.6 },
  { id: "scarlet", name: "Scarlet", weapons: ["hammer", "rocket-lance"], tier: "B", pickRate: 2.4, winRate: 49.0, deltaWR: -0.4 },
  { id: "ember", name: "Ember", weapons: ["bow", "katar"], tier: "B", pickRate: 2.3, winRate: 48.7, deltaWR: 0.2 },
  { id: "azoth", name: "Azoth", weapons: ["bow", "scythe"], tier: "B", pickRate: 2.2, winRate: 48.6, deltaWR: 0.0 },
  { id: "koji", name: "Koji", weapons: ["sword", "bow"], tier: "B", pickRate: 2.0, winRate: 48.3, deltaWR: -0.2 },
  { id: "ragnir", name: "Ragnir", weapons: ["axe", "katar"], tier: "B", pickRate: 1.9, winRate: 48.1, deltaWR: 0.3 },
  { id: "cassidy", name: "Cassidy", weapons: ["hammer", "blasters"], tier: "C", pickRate: 1.5, winRate: 47.4, deltaWR: -0.5 },
  { id: "gnash", name: "Gnash", weapons: ["hammer", "spear"], tier: "C", pickRate: 1.4, winRate: 47.0, deltaWR: 0.1 },
  { id: "vraxx", name: "Lord Vraxx", weapons: ["rocket-lance", "blasters"], tier: "C", pickRate: 1.2, winRate: 46.6, deltaWR: -0.3 },
  { id: "thatch", name: "Thatch", weapons: ["sword", "blasters"], tier: "C", pickRate: 1.1, winRate: 46.2, deltaWR: 0.4 },
]
