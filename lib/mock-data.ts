...
const DETAILED_LEGENDS: Legend[] = [
  ...
  { id: "mordex", name: "Mordex", weapons: ["scythe", "gauntlets"], tier: "S", pickRate: 6.4, winRate: 51.6, deltaWR: 0.5, imageUrl: "/assets/legends/mordex.png", bestStance: "strength" },
  { id: "diana", name: "Diana", weapons: ["bow", "blasters"], tier: "S", pickRate: 4.9, winRate: 51.2, deltaWR: 0.3, imageUrl: "/assets/legends/diana.png", bestStance: "speed" },
  { id: "asuri", name: "Asuri", weapons: ["sword", "katar"], tier: "S", pickRate: 4.1, winRate: 50.9, deltaWR: 0.2, imageUrl: "/assets/legends/asuri.png", bestStance: "strength" },
...
export const CURRENT_PATCH = "10.11"
